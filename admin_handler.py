"""HTTP handlers for admin methods"""
...
def UploadPeople(request):
    ...
    A form POST to this handler should contain a file in the field
    "file".  There should be a header row with the field names
    matching the JSON properties.  The "roles" field, however, should
    simply be a pipe ("|") separated list of role types to be saved
    with the Person.
